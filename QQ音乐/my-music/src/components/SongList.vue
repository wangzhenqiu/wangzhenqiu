<template>
    <div class="song-list" v-show="showState" @click.stop.self="close()">
        ...
        <div class="song-wrapper">
            <div class="content">
                <div class="list-con">
                    <div class="songs">
                        <ul>
                           <router-link :to="'/play/'+song.musicData.songmid + '/' + song.musicData.albummid" v-for="(song,k) in getPlayList" :key="k"  tag="div" @click.native="modifyPlayInfo(song,i)">
