...
Screen02.prototype._showCloud = function(){
	...
	this.cloudContainer.setChildIndex(this.cloud03,20);
	this.cloudContainer.setChildIndex(this.cloud02,20);
	this.cloudContainer.setChildIndex(this.cloud04,20);
	this.cloudContainer.setChildIndex(this.cloud01,20);
...
Screen02.prototype._button = function(){
	...
	this.optipcircle.alpha = 1;
	this.optipcircle.scale = 1;
